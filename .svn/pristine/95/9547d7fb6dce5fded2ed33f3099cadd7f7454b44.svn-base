...
<!-- 定义维修窗口-->
<div id="tb_maintain_dialog" class="easyui-dialog" title="维修信息" style="width:550px;height:250px;align:center;top:1px;padding:15px 15px 30px 15px;"   
...
<!-- 定义回访窗口-->
<div id="tb_returnvisit_dialog" class="easyui-dialog" title="回访信息" style="width:550px;height:250px;align:center;top:1px;padding:15px 15px 30px 15px;"   
        ...
        <table class="datagrid-btable" style="width: 96%;margin-left:2%;border: solid 1px #c0cdd8;">
       		    <tr>
	    			...
	    			<td class="td_right">
	    			    <input type="hidden" id="id" name="id"/>
	    				<input id="manid" name="man.id" style="width:180px;"/>
	    			</td>
