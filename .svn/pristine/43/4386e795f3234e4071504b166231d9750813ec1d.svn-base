...
<script type="text/javascript">
	$(function() {
			...
			$("#dg").datagrid({
					...
					//pageSize:20,
					 toolbar: '#tb',
					columns : [[{field:'style',title:'企业类型',align:'center',width:10,
					        	formatter: function(value,row,index){
									return value.text;
								}
							},
							{field : 'name',title : '企业名称',align:'center',width:10},
							{field : 'email',title : '企业邮箱',align:'center',width:10},
							{field : 'wechat',title : '微信',align:'center',width:10},
							{field : 'address',title : '详细地址',align:'center',width:10},
							{field : 'legal',title : '法人代表',align:'center',width:10},
							{field : 'phone',title : '办公室电话',align:'center',width:10},
							{field : 'cname',title : '常用联系人',align:'center',width:10},
							...
							{field : 'money',title : '欠款费用',align:'center',width:10},
