...
<div id="tb_user_add_dialog" class="easyui-dialog" title="新增报餐信息" style="width:450px;height:350px;align:center;top:1px;"   
       ...
       <form id="user_addForm" method="post">
       		...
       		<table class="datagrid-btable" style="width: 96%;margin-left:2%;border: solid 1px #c0cdd8;">
	    		<tr>
	    			<td class="td_left">报餐人数：</td>
	    			<td class="td_right"><input type="number" style="width:200px;" id="sum" name="sum" min="0"/></td>
	    		</tr>    		
	    		<tr>
	    			<td class="td_left">备注：</td>
	    			<td class="td_right"><textarea  style="width:200px;height:80px;"  id="remark" name="remark"></textarea></td>
	    		</tr>		    		
	    		<tr>
	    			<td class="td_left">记录时间：</td>
	    			<td class="td_right"><input type="text" style="width:200px;" class="easyui-datetimebox" id="createtime" name="createtime" value="08/08/2014" disabled="disabled"/></td>
	    		</tr>	    		
			</table>	
       </form>
</div>
