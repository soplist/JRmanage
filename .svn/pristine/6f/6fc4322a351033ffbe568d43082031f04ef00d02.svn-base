...
<body>
	...
	<!-- 添加开始 -->
   	<div style="display: none;">
		<div id="tj" class="easyui-dialog" title="私车信息增加"
					...
					<div style="width: 100%;">
						<table style="width: 96%;margin-left:2%;border: solid 1px #c0cdd8;border-right: none;border-bottom: none;" cellpadding="1" cellspacing="0">
								...
								<tr>
									...
									<td class="td_right">
										<select id="peopleid" editable="false" name="peopleid.id" class="easyui-combobox" style="width:325px;height: 25px;margin-left: 15px;">   
								...
								<tr>
									...
									<td class="td_right">
										<input id="yearcheck" name="yearcheck" type="text" style="width:325px;height: 25px;" class="easyui-datebox" value="1">
									</td>
								</tr>
								<tr>
									...
									<td class="td_right">
										<input id="insurance" name="insurance" type="text" style="width:325px;height: 25px;" class="easyui-datebox" value="1">
									</td>
								</tr>
								<tr>
									<td class="td_left">排量:
								...
								<tr>
									...
									<td class="td_right">
										<input id="buytime" name="buytime" type="text" style="width:325px;height: 25px;" class="easyui-datebox" value="1">
									</td>
								</tr>
								<tr>
...
<script type="text/javascript">
	$(function() {
			...
			/* 列表展示 */
			$("#dg").datagrid({
					'url' : 'privatecar_list.action',//请求的地址
					...
					columns : [[{field : 'carnumber',title : '车牌号',align:'center',width:10},
							{field:'peopleid',title:'车主',align:'center',width:10,
  ...
  /* 	function date_formatter(id){ 
  	...
  	function add(){
		...
		$('#tj').dialog({onClose:function(){
  		...
  		/* form表单提交 */	
  		initCombox01($('#peopleid'),'persionfile_findPeople.action',null,-1);
	...
	function edit(id){
		...
		var ou = document.getElementById("output").readOnly=true;
		var a = false;
		var b = false;
		//改变对话框的标题
		...
		//根据id获取信息
		$.ajax({
			    url : 'privatecar_findById.action',
			    type : "post",
			    data:{id:id},
			    dataType : "json",  
			    success : function(data)  {
				    ...
				    //给隐藏域赋值
				    $('#tj #id').val(data.id);
					initCombox01($('#peopleid'),'persionfile_findPeople.action',null,data.peopleid.id);
