...
<script type="text/javascript">
	$(function() {
			...
			$("#dg").datagrid({
					...
					//pageSize:20,
					 toolbar: '#tb',
					columns : [[{field:'style',title:'车辆类型',align:'center',width:8,
					        	formatter: function(value,row,index){
									return value.text;
								}
							},
							{field:'carnumber',title:'车牌号',align:'center',width:8,},
					        {field:'color',title:'车牌颜色',align:'center',width:6,},
							{field : 'customerid',title : '所属公司',align:'center',width:20},
							{field : 'people',title : '安装人',align:'center',width:8},
	...
	<!-- 添加开始 -->
   	<div style="display: none;">
		<div id="tj" class="easyui-dialog" title="新装车辆信息添加"
			style="width:900px;height:atuo;padding:10px 20px 20px 10px;top:15px;"
					...
					<div style="width: 100%;">
						<table style="width: 96%;margin-left:2%;border: solid 1px #c0cdd8;border-right: none;border-bottom: none;" cellpadding="1" cellspacing="0">
								<tr>
									...
									<td class="td_right">
										<select id="style" editable="false" name="style.id" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
								...
								<tr>
									...
									<td class="td_right">
										<select id="color" editable="false" name="color" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
								...
								<tr>
									...
									<td class="td_right">
										<input id="djtime" name="djtime" editable="false" type="text" style="width:210px;height: 25px;maxHeight:300px" class="easyui-datebox" value="1">
									</td>
								</tr>
								<tr>
									...
									<td class="td_right">
										<input id="lnumber" name="lnumber"  type="number" min="0" style="width:87%;" >
									</td>
								...
								<tr>
									...
									<td class="td_right">
										<select id="people" editable="false" name="people" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
									...
									<td class="td_right">
										<input id="newtime" name="newtime" editable="false" type="text" style="width:210px;height: 25px;maxHeight:300px" class="easyui-datebox" value="1">
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="td_right">
										<select id="travelcard" editable="false" name="travelcard" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
									...
									<td class="td_right">
										<select id="transcard" editable="false" name="transcard" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
									     	<option value="齐全">齐全</option>
									    	<option value="不齐">不齐</option>
										</select>
									</td>
								...
								<tr>
									...
									<td class="td_right">
										<select id="qcard" editable="false" name="qcard" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
									     	<option value="齐全">齐全</option>
									    	<option value="不齐">不齐</option>
										</select>
									</td>
									...
									<td class="td_right">
										<select id="asccenter" editable="false" name="asccenter" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
									     	<option value="齐全">齐全</option>
									    	<option value="不齐">不齐</option>
										</select>
									</td>
								...
								<tr>
									...
									<td class="td_right" colspan="3">
										<select id="transport" editable="false" name="transport" class="easyui-combobox" style="width:210px;height: 25px;margin-left: 15px;">   
									     	<option value="齐全">齐全</option>
									    	<option value="不齐">不齐</option>
										</select>
									</td>
				...
				<tr>
					<td style="border-left: solid 1px #c0cdd8;">
						<div>
							...
							起始时间：<input id="starttime"  type="text"  style="width:120px; height:90%; border: #ABCDEF 1px solid;outline-color:#96c4f3 ;"  placeholder="起始时间" class="Wdate" onfocus="WdatePicker({lang:'zh-cn',skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>&nbsp;------
							结束时间：<input id="endtime"  type="text"  style="width:120px; height:90%; border: #ABCDEF 1px solid;outline-color:#96c4f3 ;"  placeholder="结束时间" class="Wdate" onfocus="WdatePicker({lang:'zh-cn',skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
