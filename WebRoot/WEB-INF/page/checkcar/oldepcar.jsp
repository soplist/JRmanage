...
<div id="tb_oldepcar">
	...
	起始时间：<input id="starttime"  type="text"  style="width:130px;"  placeholder="此处选择起始时间" class="Wdate" onfocus="WdatePicker({lang:'zh-cn',skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>&nbsp;------
	结束时间：<input id="endtime"  type="text"  style="width:130px;"  placeholder="此处选择结束时间" class="Wdate" onfocus="WdatePicker({lang:'zh-cn',skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
...
<!-- 定义添加窗口-->
<div id="tb_oldepcar_add_dialog" class="easyui-dialog" title="新增报废车辆信息" style="width:580px;height:auto;align:center;top:1px;padding:15px 15px 30px 15px;"   
