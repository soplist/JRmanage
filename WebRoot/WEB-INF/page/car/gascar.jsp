...
<body>
	...
	<!-- 添加开始 -->
   	<div style="display: none;">
		<div id="tj" class="easyui-dialog" title="加油记录增加"
				...
				<input type="hidden" name="id" id="id" value="0">
					<div style="width: 100%;">
						<table style="width: 96%;margin-left:2%;border: solid 1px #c0cdd8;border-right: none;border-bottom: none;" cellpadding="1" cellspacing="0">
								...
								<tr>
									<td class="td_left">加油日期:
										<font color="red">*</font>
									</td>
									<td class="td_right">
										<input id="ingas" name="ingas" type="text" style="width:325px;height: 25px;" class="easyui-datetimebox" value="1">
									</td>
								</tr>
								<tr>
									<td class="td_left">加油公里数:
										<font color="red">*</font>
									</td>
									<td class="td_right">
										<input id="ingaskm" name="ingaskm" type="number" min="0" style="width:87%;">
									</td>
								</tr>
								<tr>
									<td class="td_left">加油量:
										<font color="red">*</font>
									</td>
									<td class="td_right">
										<input id="gas" name="gas" type="text" style="width:87%;">L
									</td>
								</tr>
								<tr>
									<td class="td_left">加油金额:
										<font color="red">*</font>
									</td>
									<td class="td_right">
	...
	$(function() {
			...
			$("#dg").datagrid({
					...
					columns : [[{field:'carid',title:'车辆',align:'center',width:10,},
							{field:'ingas',title:'加油日期',align:'center',width:10,},
					        {field:'ingaskm',title:'加油公里数',align:'center',width:10,},
							{field : 'money',title : '加油金额',align:'center',width:10},
							{field : 'gas',title : '加油量',align:'center',width:10},
  	...
  	function add(){
        ...
        //获取当前时间结束
        //初始化赋值
        $('#tj #ingas').datebox('setValue', currentdate);
